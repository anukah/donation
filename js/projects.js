    ...
    recoveryData.forEach(dept => {
        ...
        header.innerHTML = `
            <div class="flex flex-col md:flex-row md:items-center">
                ...
                <span class="md:ml-4 bg-blue-50 text-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider w-fit">
        ...
        dept.projects.forEach(proj => {
            ...
            ghost.innerHTML = `
                <div class="absolute top-0 left-0 w-full min-h-full bg-white rounded-xl shadow-sm border border-gray-200 p-4 flex flex-col transition-all duration-200 ease-out z-10 group-hover:z-50 group-hover:h-auto group-hover:shadow-2xl group-hover:border-blue-300 group-hover:-translate-y-1">
                    ...
                    <div class="absolute top-0 left-0 w-full h-1 ${badgeClasses.bar} rounded-t-xl"></div>

                    <div class="flex justify-between items-start mb-2 mt-2">
                        <span class="font-mono text-[10px] font-bold text-gray-500 bg-gray-100 px-2 py-1 rounded">${proj.code}</span>
                        <span class="${badgeClasses.bg} ${badgeClasses.text} border ${badgeClasses.border} text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">
                            ${proj.damage}
                        </span>
                    </div>
